...
class FsgModel(object):
    ...
    def word_str(self, wid):
        ...
        return _sphinxbase.FsgModel_word_str(self, wid)
    ...
    def writefile_fsm(self, path):
        ...
        return _sphinxbase.FsgModel_writefile_fsm(self, path)


    def writefile_symtab(self, path):
        """writefile_symtab(FsgModel self, char const * path)"""
        return _sphinxbase.FsgModel_writefile_symtab(self, path)


    def get_final_state(self):
        """get_final_state(FsgModel self) -> int"""
        return _sphinxbase.FsgModel_get_final_state(self)


    def set_final_state(self, state):
        """set_final_state(FsgModel self, int state)"""
        return _sphinxbase.FsgModel_set_final_state(self, state)


    def get_start_state(self):
        """get_start_state(FsgModel self) -> int"""
        return _sphinxbase.FsgModel_get_start_state(self)


    def set_start_state(self, state):
        """set_start_state(FsgModel self, int state)"""
        return _sphinxbase.FsgModel_set_start_state(self, state)


    def log(self, logp):
        """log(FsgModel self, double logp) -> int"""
        return _sphinxbase.FsgModel_log(self, logp)


    def get_lw(self):
        """get_lw(FsgModel self) -> float"""
        return _sphinxbase.FsgModel_get_lw(self)


    def get_name(self):
        """get_name(FsgModel self) -> char const *"""
        return _sphinxbase.FsgModel_get_name(self)


    def get_n_word(self):
        """get_n_word(FsgModel self) -> int"""
        return _sphinxbase.FsgModel_get_n_word(self)


    def has_sil(self):
        """has_sil(FsgModel self) -> bool"""
        return _sphinxbase.FsgModel_has_sil(self)


    def has_alt(self):
        """has_alt(FsgModel self) -> bool"""
        return _sphinxbase.FsgModel_has_alt(self)


    def is_filler(self, wid):
        """is_filler(FsgModel self, int wid) -> bool"""
        return _sphinxbase.FsgModel_is_filler(self, wid)


    def is_alt(self, wid):
        """is_alt(FsgModel self, int wid) -> bool"""
        return _sphinxbase.FsgModel_is_alt(self, wid)
