...
struct ExecuteSkillGoal_
{
  ...
  _trajectory_generator_param_data_size_type trajectory_generator_param_data_size;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _trajectory_generator_param_data_type;
  ...
  _feedback_controller_param_data_size_type feedback_controller_param_data_size;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _feedback_controller_param_data_type;
  ...
  _termination_handler_param_data_size_type termination_handler_param_data_size;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _termination_handler_param_data_type;
  ...
  _num_timer_params_type num_timer_params;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _timer_params_type;
