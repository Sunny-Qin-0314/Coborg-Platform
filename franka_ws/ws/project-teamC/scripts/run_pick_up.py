...
if __name__ == '__main__':
    ...
    '''
    #pose1 = rospy.wait_for_message("/aruco_simple/pose", Pose) #grab pose of aruco marker tool 1
    pose1 = rospy.wait_for_message("/aruco_simple/pose2", Pose) #grab pose of aruco marker tool 2
    ...
    goal_transformed =  azure_kinect_to_world_transform * RigidTransform(
        ...
        translation= np.array([0.37, -0.33, 0.26]),  # hard coded the goal translation relative to camera_frame
        from_frame='franka_tool', to_frame='azure_kinect_overhead'
    )
...
####################################################
    ...
    goal_transformed.translation[2] = 0.265  # goal height in the world frame
