...
if __name__ == '__main__':
    ...
    """
    Movement of franka arm: from desk to pegboard 
    0. motion planning (0.1. inital pose to tool center pose; 0.2. tool center pose to pegboard intermidiate pose)
    0. use frankapy library

    1. move to tool intermediate poses
    2. move to tool center
    3. close gripper
    4. move to pegboard intermediate poses
    5. move to pegboard goal pose
    6. open gripper
    7. move to pegboard intermediate pose
