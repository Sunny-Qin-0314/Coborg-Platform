...
"""autogenerated by genpy from hebi_cpp_api_examples/BaseMotionActionResult.msg. Do not edit."""
import codecs
import sys
...
class BaseMotionActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "hebi_cpp_api_examples/BaseMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hebi_cpp_api_examples/BaseMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BaseMotionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hebi_cpp_api_examples.msg.BaseMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hebi_cpp_api_examples.msg.BaseMotionResult()
