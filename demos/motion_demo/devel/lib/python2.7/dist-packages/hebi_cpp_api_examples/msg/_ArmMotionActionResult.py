...
"""autogenerated by genpy from hebi_cpp_api_examples/ArmMotionActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArmMotionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hebi_cpp_api_examples/ArmMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hebi_cpp_api_examples/ArmMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmMotionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hebi_cpp_api_examples.msg.ArmMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hebi_cpp_api_examples.msg.ArmMotionResult()
