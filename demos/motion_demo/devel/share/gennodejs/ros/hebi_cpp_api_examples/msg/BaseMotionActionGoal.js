...
let BaseMotionGoal = require('./BaseMotionGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BaseMotionActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BaseMotionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BaseMotionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = BaseMotionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new BaseMotionGoal()
    }
...
module.exports = BaseMotionActionGoal;
