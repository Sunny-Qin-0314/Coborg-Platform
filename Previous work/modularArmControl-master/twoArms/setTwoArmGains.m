...
gains.positionKp= ones_n*2;
gains.positionKi= ones_n*1000*.07;
gains.positionKd= ones_n*.001*.5;
...
gains.effortMinTarget= ones_n*-10;
gains.effortMaxTarget= ones_n*10;
gains.effortMinOutput= ones_n*-1;
gains.effortMaxOutput= ones_n;
gains.effortTargetLowpassGain= ones_n;
gains.effortOutputLowpassGain= ones_n;
gains.effortDOnError= ones_n*0;


robotLeft.set('gains', gains);
robotRight.set('gains', gains);

%                robot.setCommandLifetime(0); % so the commands don't expire
               robotLeft.setCommandLifetime(1); % so the commands expire
               robotRight.setCommandLifetime(1); % so the commands expire
