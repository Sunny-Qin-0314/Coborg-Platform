...
"""autogenerated by genpy from hebi_cpp_api_examples/ArmMotionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ArmMotionActionFeedback(genpy.Message):
  _md5sum = "67446a63b636306740fa43e59f799c78"
  _type = "hebi_cpp_api_examples/ArmMotionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hebi_cpp_api_examples/ArmMotionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmMotionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hebi_cpp_api_examples.msg.ArmMotionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hebi_cpp_api_examples.msg.ArmMotionFeedback()
