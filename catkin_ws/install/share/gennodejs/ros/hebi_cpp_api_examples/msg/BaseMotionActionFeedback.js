...
let BaseMotionFeedback = require('./BaseMotionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BaseMotionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new BaseMotionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BaseMotionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BaseMotionActionFeedback(null);
    ...
    data.feedback = BaseMotionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BaseMotionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BaseMotionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BaseMotionFeedback()
    }
...
module.exports = BaseMotionActionFeedback;
