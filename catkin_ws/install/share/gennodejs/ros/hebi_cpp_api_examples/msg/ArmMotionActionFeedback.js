...
let ArmMotionFeedback = require('./ArmMotionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ArmMotionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArmMotionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArmMotionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArmMotionActionFeedback(null);
    ...
    data.feedback = ArmMotionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArmMotionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArmMotionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArmMotionFeedback()
    }
...
module.exports = ArmMotionActionFeedback;
