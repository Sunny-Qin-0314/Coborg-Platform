...
void YoloObjectDetector::init() {
  ...
  nodeHandle_.param("yolo_model/weight_file/name", weightsModel, std::string("cross-hands-tiny.weights"));
  ...
  // Path to config file.
  nodeHandle_.param("yolo_model/config_file/name", configModel, std::string("cross-hands-tiny.cfg"));
