...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cmu_motor_lab' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hwadi/Coborg-Platform/arduino_ws/src/cmu_motor_lab/${idir}'.  ${_report}")
    endif()
